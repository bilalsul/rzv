  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Stack(
          children: [
            // Main content with floating navigation bar
            _buildMainContent(
              currentScreen,
          plugins,
          prefs,
            ...
            if (_isEditorSheetVisible)
              Positioned.fill(
                child: _buildEditorSheet(context, prefs),
              ),
          ],
        ),
      ),
  ...
  Widget _buildMainContent(
    ...
    return Column(
      children: [
        ...
        _buildFloatingNavigationBar(plugins, currentScreen, prefs),
      ],
    );
  }
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            child: Hidable(
              controller: scrollController,
              preferredWidgetSize: const Size.fromHeight(60),
              child: BottomNavigationBar(
                ...
                onTap: (index) {
                  ...
                  if (selectedScreen == Screen.editor) {
                    ...
                    // Hide editor sheet if it's open
                    if (_isEditorSheetVisible) {
                      _hideEditorSheet();
                    }
                  }
