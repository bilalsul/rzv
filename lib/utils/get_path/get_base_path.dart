...
Future<String> getGitExpDocumentsPath() async {
...
Future<Directory> getGitExpDocumentDir() async {
  return Directory(await getGitExpDocumentsPath());
}

void initBasePath() async {
  Directory appDocDir = await getGitExpDocumentDir();
